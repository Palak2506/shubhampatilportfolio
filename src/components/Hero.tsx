...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen text-white" style={{ position: 'relative', isolation: 'isolate', overflow: 'hidden', background: 'linear-gradient(to bottom right, #0b1120, #05070d, #020204)' }}>
      <svg
        aria-hidden
      ...
      <div className="container mx-auto px-6 text-center relative z-20">
        <div className="animate-fade-in relative z-20">
          <div className="mb-8 flex justify-center mt-10 relative z-20">
            <div className="relative z-20">
              <div className="w-44 h-44 rounded-full border-4 border-white/20 shadow-xl overflow-hidden relative z-20">
                <img
                  src={profileImage}
                  alt="Shubham Patil"
          ...
          <div className="flex justify-center mt-4 relative z-20">
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg relative z-20"
            >
              Learn More About Me
